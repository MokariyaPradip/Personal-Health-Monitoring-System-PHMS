...
# ===============================
print("\nTraining Random Forest v5 with GridSearchCV on all datasets...")
...
# 8. SAVE MODEL
# ===============================
model_path = os.path.join(BASE_DIR, "..", "trained_models", "phms_model_v5.pkl")
encoder_path = os.path.join(BASE_DIR, "..", "trained_models", "label_encoder_v5.pkl")

joblib.dump(best_model, model_path)
joblib.dump(label_encoder, encoder_path)

print("\n" + "="*60)
print("Random Forest v5 model saved successfully.")
print(f"Model:   {model_path}")
print(f"Encoder: {encoder_path}")
print("="*60)
print("\nv5 trained on ALL 4 datasets (~26k samples)")
print("v4 was trained on 2 datasets (~3.9k samples)")
print("="*60)
...
# Train size: 20707, Test size: 5177
...
# GRID SEARCH RESULTS
# ============================================================
# Best RF Params: {'class_weight': 'balanced', 'max_depth': 20, 'max_features': 'sqrt', 'min_samples_leaf': 2, 'min_samples_split': 5, 'n_estimators': 200}
# Best CV F1 (weighted): 0.9502
...
# Feature Importance (Top 5):
#           feature  importance
# 6     temperature    0.228844
# 2           sugar    0.193764
# 1  blood_pressure    0.172775
# 4     sleep_hours    0.127173
# 0             bmi    0.110529

# ============================================================
# Random Forest v5 model saved successfully.
# Model:   c:\Users\Admin\Desktop\Sem-06\2_SDP\project\PHMS\ml\training_scripts\..\trained_models\phms_model_v5.pkl
# Encoder: c:\Users\Admin\Desktop\Sem-06\2_SDP\project\PHMS\ml\training_scripts\..\trained_models\label_encoder_v5.pkl
# ============================================================

# v5 trained on ALL 4 datasets (~26k samples)
# v4 was trained on 2 datasets (~3.9k samples)
# ============================================================